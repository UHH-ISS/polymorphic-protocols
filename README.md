...
- Start with "" "" "custom.package.name" to set the package name to custom.package.name
...
- Basic Wrapper idea: WrapperIdea.java
- Autogenerated File by Google Protoc like the Polymorph wraps around: AutogeneratedByProtoc.java
...
- Incase gradle is misbehaving  rerun the gradle installation process & try to use java sdk by eclipse temurin
